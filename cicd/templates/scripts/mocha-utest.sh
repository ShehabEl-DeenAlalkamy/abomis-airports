...
main() {
    ...
    ./node_modules/nyc/bin/nyc.js --reporter=cobertura --reporter=html ./node_modules/mocha/bin/mocha --timeout 5000 --recursive test/unit --reporter mocha-junit-reporter --reporter-options mochaFile="${BUILD_ARTIFACTSTAGINGDIRECTORY}"/utests/jsc/mocha-out.xml
